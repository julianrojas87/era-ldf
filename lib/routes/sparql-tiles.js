...
export async function sparqlTiles(fastify, options) {
    ...
    fastify.options('/ldf-virtuoso/sparql-tiles/*', async (request, reply) => {
    ...
    fastify.get('/ldf-virtuoso/sparql-tiles/implementation/:z/:x/:y', async (request, reply) => {
    ...
    fastify.get('/ldf-virtuoso/sparql-tiles/abstraction/:z/:x/:y', async (request, reply) => {
        const lat1 = tile2lat(parseFloat(request.params.y), parseFloat(request.params.z));
        const lon1 = tile2long(parseFloat(request.params.x), parseFloat(request.params.z));
